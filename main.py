...
def ficha_personal ():
    ...
    pg.mixer.init()
    pg.mixer.music.load("resources/Cancion_audioP3.mp3")#importación de audio
    def cerrar_window2():
    ...
    #Imagenes pillow
    img_me = Image.open("resources/Me_foto.JPEG").resize((170, 170))#Tamaño de imagen
    ...
    img_lugar = Image.open("resources/Home_foto.jpeg").resize((170, 170))
    ...
    img_hobby = Image.open("resources/hobby_foto.jpg").resize((170, 170))
    ...
    img_artist = Image.open("resources/Mac_foto.jpg").resize((170, 170))
    ...
    def music_control():
        ...
        if music_on == False:
            try:
                pg.mixer.music.load("resources/Cancion_audioP3.mp3")# Carga el archivo de audio desde la ruta especificada
...
Back_image = Image.open("resources/Background_main.jpg").resize((WIDTH, HEIGHT))
